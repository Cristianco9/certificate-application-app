...
export function LoginPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col lg:flex-row">
      ...
      >
        {/* Copy — animates in like the welcome heading */}
        <div
          className="
            relative z-10 flex flex-col px-12 py-14 xl:px-10
        ...
        >
          ...
          <p className="mt-4 max-w-sm text-sm leading-relaxed text-white/85">
            Consulta, genera y administra certificados de estudiantes
            graduados desde un único lugar.
          </p>
        </div>

        {/* Illustration — same float + slide-in as welcome */}
